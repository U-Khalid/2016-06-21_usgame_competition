		...
		try {
			...
			for (FileItem item : list) {
				...
				if (item.isFormField()) {
					...
					String savepath = this.getServletContext().getRealPath("/WEB-INF/uploadStudents");
					...
					List<ApplyReport> applyReports = excel.importstudentsExcel(savepath+"\\"+filename);
					
					result = comService.importstudents(applyReports);
